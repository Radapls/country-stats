...
export class HeaderComponent
{
    ...
    public DARK_MODE: string = `<svg xmlns="http://www.w3.org/2000/svg" height="12" width="12">
  ...
  `;
    ...
    {
        iconRegistry.addSvgIconLiteral('dark-mode', sanitizer.bypassSecurityTrustHtml(this.DARK_MODE))
    }
